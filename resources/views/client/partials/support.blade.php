...
<div class="textwidget custom-html-widget">
    <div class="show-btn-wrapper">
        <div class="zalo-chat-custom " aria-hidden="true"><img class="blink" style="filter: brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(7124%) hue-rotate(333deg) brightness(116%) contrast(102%);" width="36" height="38"
                ...
                alt="về {{ CHomeController::settings()->name }}"
        ...
        <div class="zalo-chat-custom-no-active">
            <a id="zalo-button" href="https://zalo.me/{{ CHomeController::settings()->zalo }}" target="_blank"
            ...
            <a id="mesenger-button" href="{{ CHomeController::settings()->fanpage }}" target="_blank"
            ...
            <a id="call-button" href="tel:{{ CHomeController::settings()->phone }}" class="float-button3"
...
">
                <div class="ak-info">
                    ...
                    <div class="welcome-text">
                        {{ CHomeController::settings()->name }} xin kính
                        chào quý khách</div>
                    </p>
                </div>
            </div>
