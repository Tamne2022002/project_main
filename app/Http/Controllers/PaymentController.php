    ...
    public function combination(Request $request) {
        ...
        if ($request['payment_method'] === 'vnpay') { 
           ...
           foreach (session('selected_products') as $id => $details) {
            ...
            $vnp_TmnCode = "QD3Y6D5D"; //Mã website tại VNPAY
            $vnp_HashSecret = "ATQLFOK2W0ARL4Z2DEME7ONAENFWM5QB"; //Chuỗi bí mật

            $vnp_OrderInfo = "Thanh toán hoá đơn";
            $vnp_OrderType = "TPStore";
        ...
        /* Thanh toán QR */
        else if($request['payment_method'] === 'vietqr') {
            $orderInfo = new OrderModel;
